...
class ClipBoardResourceIT {
    ...
    public static ClipBoard createEntity(EntityManager em) {
        ClipBoard clipBoard = new ClipBoard().content(DEFAULT_CONTENT).date(DEFAULT_DATE);
        return clipBoard;
    }
    ...
    public static ClipBoard createUpdatedEntity(EntityManager em) {
        ClipBoard clipBoard = new ClipBoard().content(UPDATED_CONTENT).date(UPDATED_DATE);
        return clipBoard;
    }
    ...
    void createClipBoard() throws Exception {
        ...
        assertThat(testClipBoard.getDate()).isEqualTo(DEFAULT_DATE);
    }
    ...
    void putExistingClipBoard() throws Exception {
        ...
        updatedClipBoard.content(UPDATED_CONTENT).date(UPDATED_DATE);
        ...
        assertThat(testClipBoard.getDate()).isEqualTo(UPDATED_DATE);
    }
    ...
    void partialUpdateClipBoardWithPatch() throws Exception {
        ...
        partialUpdatedClipBoard.content(UPDATED_CONTENT).date(UPDATED_DATE);
